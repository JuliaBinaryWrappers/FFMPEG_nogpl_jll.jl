# `FFMPEG_nogpl_jll.jl` (v8.1.0+0)

[![deps](https://juliahub.com/docs/FFMPEG_nogpl_jll/deps.svg)](https://juliahub.com/ui/Packages/General/FFMPEG_nogpl_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/168c568d11ba48192d63cb24896b03ec4f7928d5/F/FFMPEG/FFMPEG_nogpl/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `FFMPEG_nogpl_jll.jl` have been built from these sources:

* compressed archive: https://ffmpeg.org/releases/ffmpeg-8.1.tar.xz (SHA256 checksum: `b072aed6871998cce9b36e7774033105ca29e33632be5b6347f3206898e0756a`)
...
`FFMPEG_nogpl_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `FFMPEG_nogpl_jll.jl`:
...
* [`libva_jll`](https://github.com/JuliaBinaryWrappers/libva_jll.jl)
